...
<body class="city-seo-page eg-v2 font-[Poppins] overflow-x-hidden">
...
<script src="../js/init-transition.js"></script><script src="../lib/aos/aos.js" defer></script><script src="../js/app.js?v=3" defer></script>
...
<section class="city-snapshot" aria-label="${c.name} Einsatzgebiet"><article><span>Einsatzgebiet</span><strong>${c.name} + Umgebung</strong></article><article><span>Standorte</span><strong>Magstadt / Fellbach</strong></article><article><span>Anfrage</span><strong>Projektbezogen</strong></article></section>
<section class="eg-intro"><div class="eg-intro__body" data-aos="fade-up"><span class="eg-eyebrow">Einsatzgebiet</span><h2>Bauleistungen für ${c.name} und Umgebung.</h2><p class="eg-lead">Ob Rohbau, Tiefbau, Stahlbetonbau oder koordinierte Hochbauleistungen: Bei Projekten in ${c.name} kommt es auf saubere Vorbereitung, klare Abstimmung und verlässliche Ausführung an.</p><p>HK Bau prüft Anfragen aus ${c.name} sowie aus ${c.neighborsText.join(", ")}. Je nach Umfang, Terminplan und Leistungsbereich begleiten wir Bauvorhaben im erweiterten Umkreis der Region Stuttgart.</p><a class="eg-cta-btn" href="../kontakt.html">Projekt in ${c.name} anfragen <svg viewBox="0 0 24 24" fill="none" width="16" height="16" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"/></svg></a></div></section>
<section class="eg-about"><div data-aos="fade-up"><span class="eg-eyebrow">${c.name} im Überblick</span><h2>Bauen in ${c.name} – Standort und Rahmenbedingungen.</h2>${c.about
    .map((p) => `<p>${p}</p>`)
    .join("")}</div><ul class="eg-checklist" data-aos="fade-up" data-aos-delay="100"><li><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M20 6 9 17l-5-5" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>Rohbau, Stahlbeton- und Mauerwerksbau</li><li><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M20 6 9 17l-5-5" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>Tiefbau, Baugruben &amp; Kanalbau</li><li><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M20 6 9 17l-5-5" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>Hochbau &amp; Koordination der Gewerke</li><li><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M20 6 9 17l-5-5" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>Schlüsselfertige Umsetzung bis zur Übergabe</li></ul></section>
<section class="eg-why"><div class="seo-section-head" data-aos="fade-up"><span class="eg-eyebrow">Warum HK Bau</span><h2>Regional verwurzelt, verlässlich gebaut.</h2></div><div class="eg-why__grid"><div class="eg-feat" data-aos="fade-up"><div class="eg-feat__ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" aria-hidden="true"><path d="M12 2 3 7v6c0 5 4 8 9 9 5-1 9-4 9-9V7l-9-5Z"/><path d="m9 12 2 2 4-4"/></svg></div><h3>Alles aus einer Hand</h3><p>Rohbau bis schlüsselfertig – ein Ansprechpartner über das ganze Projekt.</p></div><div class="eg-feat" data-aos="fade-up" data-aos-delay="100"><div class="eg-feat__ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" aria-hidden="true"><path d="M12 21s-7-5.2-7-10a7 7 0 0 1 14 0c0 4.8-7 10-7 10Z"/><circle cx="12" cy="11" r="2.5"/></svg></div><h3>Regional verwurzelt</h3><p>Zwei Standorte in der Region Stuttgart, kurze Wege zur Baustelle.</p></div><div class="eg-feat" data-aos="fade-up" data-aos-delay="200"><div class="eg-feat__ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg></div><h3>Termintreue</h3><p>Saubere Planung und verlässliche Ausführung nach Zeitplan.</p></div></div></section>
...
const CITIES = [
  {
    ...
    about: [
      "Magstadt ist der Hauptstandort von HK Bau. Von der Blumenstraße 33a aus betreuen wir Bauprojekte in Magstadt und der gesamten Region Böblingen.",
